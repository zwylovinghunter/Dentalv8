...
EXP_NAME="v3_exp02_loss_hybrid_ciou_piou_yolov8n_e200_i960_b40_p30"
...
screen -dmS v3_exp02_loss_hybrid_piou bash -lc "cd /root/autodl-tmp/yolov8 && /root/miniconda3/bin/python - <<'PY' > '${LOG}' 2>&1
import sys
...
echo "started screen=v3_exp02_loss_hybrid_piou log=${LOG} result=${RESULT_DIR}"
